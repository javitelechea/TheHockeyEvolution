/**
 * THE HOCKEY EVOLUTION — Formulario de consulta → Google Sheets + Email
 *
 * IMPORTANTE: Este script debe estar DENTRO de tu Google Sheet de INSCRIPCIONES.
 ...
 * 6. Copiá la URL /exec NUEVA en js/config.js → GOOGLE_SCRIPT_URL
 * 7. Subí config.js y main.js a GitHub
 *
 * VERIFICAR: abrí la URL /exec en el navegador. Debe decir {"status":"ok","version":5}
 *
 * NOTA: Para devoluciones del camp usá scripts/google-apps-script-devolucion.gs
 * en otra Sheet aparte.
 */
